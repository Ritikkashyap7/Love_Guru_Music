...
OWNER_NAME = getenv("OWNER_NAME", "Ritik_kashyap_7")
ALIVE_NAME = getenv("ALIVE_NAME", "Ritik")
BOT_USERNAME = getenv("BOT_USERNAME", "Love_Guru_Music_bot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Ritik_kashyap_7")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "Yarri_ka_circle_7")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Yarri_ka_circle_7")
SUDO_USERS = list(map(int, getenv("SUDO_USERS").split()))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
ALIVE_IMG = getenv("ALIVE_IMG", "https://te.legra.ph/file/de3dce819a91c99243f9e.jpg")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "60"))
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Ritikkashyap7/Love_Guru_Music.git")
